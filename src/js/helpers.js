...
function(Lum)
{
  ...
  const objlib = Lum.obj;
  const optlib = Lum.opt;

  console.warn("Lum 'helpers' library is deprecated",
    "Use 'obj' or 'opt' directly instead", objlib, optlib, Lum, wrap);

// Wrappers for stuff in the 'obj' library now.
...
// Wrappers for stuff in the 'opt' library now.
