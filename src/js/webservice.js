...
export default class WebService
{
  constructor (options)
  {
    ...
    if ('methods' in options)
    {
      ...
      for (var method_name in options.methods)
      {
        ...
        this._add_handler(method_name, method_handler);
      }
    }
   ...
   */
  _add_handler (method_name, method_handler)
  {
   ...
   */
  _build_json_request_data (data, wrapper, noEmpty)
  {
